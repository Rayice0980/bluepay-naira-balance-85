...
const ContactUs = () => {
  const handleWhatsAppContact = () => {
    const phoneNumber = "2348143247192";
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card className="bg-white border-blue-100 shadow-lg">
          <div className="p-8 text-center space-y-6">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <p className="text-bluepay-600 font-medium text-lg">+234 814 324 7192</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-white border-blue-100 p-4 text-center">
            ...
            <p className="text-sm text-gray-600">+234 814 324 7192</p>
          </Card>

          <Card className="bg-white border-blue-100 p-4 text-center">
            <Mail className="h-6 w-6 text-bluepay-500 mx-auto mb-2" />
            <h3 className="font-medium text-gray-900">Email</h3>
            <p className="text-sm text-gray-600">support@bluepay.com</p>
          </Card>
